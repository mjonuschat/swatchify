...
textstring3="Pistachio Green";

//Set font size in mm
textsize_lower=5; 

//Top text (on the top edge, to quickly find the material type). 
texttop=" P E T G";//[-,P L A, A B S, P E T G, N y l o n, P V B, H I P S, P E E K, T P U, P O M, P V A, P P, A S A, P C, U L T E M, R e s i n, P A, n G E N, H T, P H A, A M 1 8 0 0,A M 3 3 0 0,N G E N _ F L E X,P U R,F L 6 0 0 0]
...
edge_tests="enabled";//[enabled,disabled]
...
module rounded_square_test_pattern_raised(x,y,z,r,text_type, edge_tests)
{ 
    //sphere test
    if(test_circles>=1)
...
{            
    ...
    difference()
    {
        ...
        write_text_on_top(w,h,th,(edge_tests=="enabled"?wall:round));
    ...
    if(edge_tests=="enabled")
    {    
        rounded_square_test_pattern_raised(w,h,th,round,text_type, edge_tests);
    }
